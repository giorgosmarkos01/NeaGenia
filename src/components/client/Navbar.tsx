      ...
      <nav className="mx-auto flex max-w-6xl items-center justify-between px-4 py-3">
        ...
        <div className="flex items-center gap-6">
          ...
          >
            ...
            {count > 0 && (
              <span className="absolute -right-1 -top-1 inline-flex min-w-[18px] translate-x-1/2 -translate-y-1/2 items-center justify-center rounded-full bg-blue-500 px-1.5 text-[10px] font-semibold leading-4 text-white">
                {count}
              </span>
            )}
          </Link>
